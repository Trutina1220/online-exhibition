...
var createScene =  () => {
    ...
    // Stand 2
    var stand2 = BABYLON.MeshBuilder.CreateBox("stand2", {height: 1, width: 1.1, depth: 3.5});
    stand2.checkCollisions = true;
    stand2.rotation.y = Math.PI/2;
    stand2.position = new BABYLON.Vector3(-1.5, 0.5, 5.5);

    // Stand 3
    var stand3 = BABYLON.MeshBuilder.CreateBox("stand3", {height: 1, width: 1.1, depth: 3.5});
    stand3.checkCollisions = true;
    stand3.rotation.y = Math.PI/2;
    stand3.position = new BABYLON.Vector3(-9.5, 0.5, 5.5);
    
    // Chair 
    var chair1 = BABYLON.SceneLoader.ImportMesh("chair1", "Assets/Chair/", "modern chair 11 obj.obj", scene, function (meshes) {          
        for (mesh in meshes) {
            meshes[mesh].position = new BABYLON.Vector3(0, 3, 0);
        }
